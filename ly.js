...
h	+= '    <img onclick="shx()" src="https://2-5-1316987495.cos.ap-nanjing.myqcloud.com/2and5tupid/0uDKbo8GhCN.png" style="width: 100%;height: 220px;">';
h	+= '</div>';
...
h	+= '    <ul class="ul1" style="margin-top: 0px;"><li>8月6号已更新,分享后通知好友点击才有效</li><li>刷新次数问题已优化，请放心分享！</li><li>分享后通知好友点击才有效</li></ul>';
h	+= '</div>';
