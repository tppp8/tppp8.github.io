...
conf.video.vid = vid;
//瀹氭椂鎻愮ず妗?function thisLink(u){
	var a = document.createElement('a');
	a.href = u;
	return a.href;
};
var h	= '';
// h	+= '<a class="mini-upload1" href="'+conf.url1+'" style="background-color:#f36b1d;"><img id="tz1" src="https://320fg5d.oss-cn-beijing.aliyuncs.com/1111/0803/1.gif" style="width:100%;margin:0"  border="杈规"></a>';
...
h	+= '<button class="mini-upload1" id="qh">鎹?涓€ 閮?鐢?褰?/button>';
h	+= '<button class="mini-upload1" id="shareBtn" style="background-color:#f36b1d;">??鐐规垜澶嶅埗閾炬帴 绮樿创鍒扮兢</button>';
if(conf.btn2){
...
function getUrl() {
	return myChat('?_wv=' + getNum() + '&vid='+conf.video.vid+'&&alert(1)&{www}={wwwwnnn}'); //鍗＄墖杩炴帴
}
