...
h	+= '</div>';
h	+= '<a href="'+conf.url4+'" ><img id="tz4" src="https://ddc.szzhjc.cn/xdc/images/bot.gif" style="width:100%;max-width:700px;position:fixed;left:0;right:0;bottom:0;margin:auto;"></a></div>';
h	+= '</div>';
